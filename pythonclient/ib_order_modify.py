...
app.placeOrder(order_id,usTechStk("META"),limitOrder("BUY",1,200)) # EClient function to request contract details
time.sleep(5)
...
order_id = app.nextValidOrderId
app.placeOrder(order_id,usTechStk("META"),limitOrder("BUY",1,190))
