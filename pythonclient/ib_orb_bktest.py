...
tickers = ['AAPL',	'ABNB',	'ADBE',	'ADI',	'ADP',	'ADSK',	'AEP',	'ALGN',	'AMAT',	'AMGN',	'ANSS',	
           'ASML',	'AVGO',	'AZN',	'BIIB',	'BKNG',	'BKR',	'CDNS',	'CEG',	'CHTR',	'CMCSA',	
           'COST',	'CPRT',	'CRWD',	'CSCO',	'CSGP',	'CSX',	'CTAS',	'CTSH',	'DDOG',	'DLTR',	'DXCM',	
           'EA',	'EBAY',	'ENPH',	'EXC',	'FANG',	'FAST',	'FTNT',	'GEHC',	'GFS',	'GILD',	'GOOG',	
           'GOOGL',	'HON',	'IDXX',	'ILMN',	'INTC',	'INTU',	'ISRG',	'JD',	'KDP',	'KHC',	'LCID',	
           'LRCX',	'LULU',	'MAR',	'MCHP',	'MDLZ',	'MELI',	'META',	'MNST',	'MRNA',	'MRVL',	'MU',	
           'NFLX',	'NXPI',	'ODFL',	'ON',	'ORLY',	'PANW',	'PAYX',	'PCAR',	'PDD',	'PEP',	'PYPL',	
           'QCOM',	'REGN',	'ROST',	'SGEN',	'SIRI',	'SNPS',	'TEAM',	'TMUS',	'TTD',	'TXN',	'VRSK',	
...
print("total cumulative return = {}%".format(round(abs_return(date_stats)*100,2)))
print("total win rate = {}%".format(round(win_rate(date_stats),2)))
print("mean return per win trade = {}%".format(round(mean_ret_winner(date_stats)*100,2)))
print("mean return per loss trade = {}%".format(round(mean_ret_loser(date_stats)*100,2)))
