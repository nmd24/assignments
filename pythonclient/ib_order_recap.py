...
app.placeOrder(app.nextValidOrderId,usStk("META"),lmtOrder("BUY",5,311)) # EClient function to request contract details
...
app.reqIds(3) #reqId api updated the nextValidOrderId class variable with the available order id
time.sleep(2) #some lag needs to be introduced
app.placeOrder(app.nextValidOrderId,usStk("INTC"),lmtOrder("BUY",10,1))
