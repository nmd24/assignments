...
def usStkScan(asset_type="STK",asset_loc="STK.NASDAQ",scan_code="LOW_OPEN_GAP",marketCapAbove = 10000):
    scan_obj = ScannerSubscription()
    scan_obj.numberOfRows = 5
    scan_obj.instrument = asset_type
    scan_obj.locationCode = asset_loc
    scan_obj.scanCode = scan_code
    scan_obj.marketCapAbove = marketCapAbove
    return scan_obj
